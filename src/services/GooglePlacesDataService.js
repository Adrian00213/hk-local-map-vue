...
const ADDRESS_TO_DISTRICT = {
  '中西區': ['Central', 'Sheung Wan', 'Sai Ying Pun', 'Western', 'Mid-Levels', 'Victoria Peak', 'Admiralty', '中環', '上環', '西環', '金鐘', '山頂', '中環站', '上環站'],
  '灣仔': ['Wan Chai', 'Causeway Bay', 'Tin Hau', 'Causeway', 'Wanchai', '銅鑼灣', '天后', '跑馬地', '灣仔', '銅鑼灣站', '天后站'],
  '東區': ['Eastern', 'North Point', 'Quarry Bay', 'Sai Wan Ho', 'Chai Wan', 'Siu Sai Wan', '北角', '鰂魚涌', '西灣河', '柴灣', '北角站', '鰂魚涌站'],
  '南區': ['Southern', 'Aberdeen', 'Stanley', 'Repulse Bay', 'Deep Water Bay', 'Lantau', 'South Side', '香港仔', '赤柱', '南丫島', '長洲', '大嶼山', '香港仔站', '赤柱站'],
  '油尖旺': ['Tsim Sha Tsui', 'Mong Kok', 'Yau Ma Tei', 'Jordan', 'Kowloon City', 'TST', '旺角', '油麻地', '尖沙咀', '佐敦', '何文田', '旺角站', '油麻地站', '尖沙咀站', '佐敦站'],
  '九龍城': ['Kowloon City', 'Kowloon Tong', 'Hung Hom', 'Whampoa', 'Lo Fu Hang', '九龍塘', '紅磡', '黃埔', '九龍城', '紅磡站', '黃埔站'],
  '深水埗': ['Sham Shui Po', 'Shek Kip Mei', 'Lai Chi Kok', 'Cheung Sha Wan', '長沙灣', '石硤尾', '又一村', '深水埗', '長沙灣站', '石硤尾站'],
  '黃大仙': ['Wong Tai Sin', 'Diamond Hill', '龍翔道', '慈雲山', '鑽石山', '黃大仙', '黃大仙站'],
  '觀塘': ['Kwun Tong', 'Ngau Tau Kok', 'Jordan Valley', '觀塘市中心', '牛頭角', '九龍灣', '觀塘', '牛頭角站', '九龍灣站'],
  '葵青': ['Kwai Tsing', 'Kwai Chung', 'Tsing Yi', '葵涌', '青衣', '荔景', '葵芳', '葵芳站', '青衣站', '荔景站'],
  '荃灣': ['Tsuen Wan', 'Discovery Bay', '荃灣市中心', '愉景新城', '萬景峰', '荃灣', '荃灣站', '荃灣西站'],
  '屯門': ['Tuen Mun', 'So Kwun Wat', '屯門市中心', '良田', '屯門', '屯門站'],
  '元朗': ['Yuen Long', 'Tin Shui Wai', 'Hung Shui Kiu', '元朗市中心', '形點', 'YOHO', '天水圍', '元朗', '元朗站', '天水圍站'],
  '北區': ['North District', 'Sheung Shui', 'Fanling', 'Sha Tau Kok', '上水', '粉嶺', '沙頭角', '打鼓嶺', '上水站', '粉嶺站'],
  '西頁': ['Sai Kung', 'Tseung Kwan O', '將軍澳', '坑口', '寶琳', '康城', '調景嶺', '西貢', '將軍澳站', '坑口站', '寶琳站'],
  '沙田': ['Sha Tin', 'Ma On Shan', 'Tai Shui Hang', '沙田市中心', '馬鞍山', '大圍', '火炭', '沙田圍', '沙田', '沙田站', '大圍站', '馬鞍山站'],
  '大埔': ['Tai Po', 'Tai Po Town', '大埔墟', '科學園', '太和', '運頭塘', '大埔', '大埔墟站', '太和站'],
}
